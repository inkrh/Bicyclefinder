...
//    static let networkURL = "https://api.citybik.es/networks.json"
    ...
    //TO create Apple maps directions -
    static var appleMapsURL = "https://maps.apple.com/?daddr=%@,%@"
    //most of the below is no longer used
    ...
    static let tryingNetworks = "getting bike networks"
    ...
    BicycleFinder is an independently created app which uses information from the citybik.es api. Although every effort has been made to ensure reliability, bike station details and the number of available bikes cannot be guaranteed.
    """
}
